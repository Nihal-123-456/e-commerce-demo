    ...
    <div className="flex flex-col items-center min-h-screen p-6 w-full bg-white">
          ...
          return (
            <motion.div
              className={`flex flex-col items-center justify-center w-48 h-44 rounded-2xl border-2 transition-all ${
                isSelected
                  ? "bg-blue-100 shadow-lg border-blue-600"
      ...
      >
        ...
        <input
          type="tel"
          id="mobile"
          className="w-64 md:w-80 px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-800"
